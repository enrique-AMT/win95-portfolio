...
const contactLinks = [
  {
    icon: <FaGithub size={24} />, label: "GitHub", url: "https://github.com/enrique-amt" },
  {
    icon: <FaLinkedin size={24} />, label: "LinkedIn", url: "https://linkedin.com/in/enrique-amt" },
  {
    icon: <Mail variant="32x32_4" />, label: "Gmail", url: "mailto:enrique.marrero95@gmail.com" },
];
